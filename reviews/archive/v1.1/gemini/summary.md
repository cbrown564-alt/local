...
None of the five candidates met the publication standard set in [`CONCEPT_DESIGN_REVIEW.md`](../../CONCEPT_DESIGN_REVIEW.md) (minimum 7.0/10 weighted score, all core category floors $\ge 7.0$, all supporting category floors $\ge 6.0$, and 100% design gates passing).
