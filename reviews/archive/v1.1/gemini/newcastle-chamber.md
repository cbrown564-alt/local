...
Current presence and verification: `research/verifications.json`, record
...
- Current capture: `public/images/newcastle-chamber-before.jpg` — the Chamber's
...
- Desktop after, 1265×710: `.tmp/nc-shots/home__desktop.png` (and the supplied
  `research/concept-reviews/evidence/phase-q-rereview/newcastle-chamber__desktop-1265x710.png`).
...
- Sources, asset credits and limitations: `research/verifications.json`,
  `research/chamber-website-brief.md`, `public/images/place/ATTRIBUTION.md`.
- Asset source and public-use rights status: `/images/place/central-promenade.jpg`
...
| Subject identity and distinctiveness | 15% | 6.0 | 0.900 | Harbour navy + civic brass + Newsreader; seal traced from the Chamber's real circular mountain logo; "50A Main Street", "under the Mournes", Co. Down strip. | The seal is honest identity archaeology — it comes from the subject's only existing brand asset. | The swap-the-business test costs one town name and one photograph; and the focus ring is gorse yellow `rgb(224,193,77)`, the Mourne Made studio colour that `DESIGN.md` says must never appear inside a concept screen. |
...
2. **Separate real businesses from invented ones, or invent all of them.** Either
   ...
   either resolves to a `research/verifications.json` record or is visibly marked
