...
|---|---|---|
| `dawn` | 04:00 – 09:59 | `public/media/concepts/hotel-enniskeen/enniskeen-faithful-house-dawn.jpg` *(exists)* |
| `day` | 10:00 – 17:59 | `public/media/concepts/hotel-enniskeen/enniskeen-faithful-house.png` *(exists)* |
| `dusk` | 18:00 – 03:59 | `public/media/concepts/hotel-enniskeen/enniskeen-faithful-house-dusk.jpg` *(exists)* |
...
- Alt text and the `Provisional visualisation` caption for each variant are
  already written in `src/concepts/hotel-enniskeen/content.ts` and swap with the image.
...
`research/image-provenance.md` applies unchanged: preserve the
...
**Use `public/media/concepts/hotel-enniskeen/enniskeen-faithful-house.png` as the reference image**, not
...
section of `research/image-provenance.md`.
