...
(verified this session with `node scripts/check-concept-reviews.mjs --fingerprint cupla`)  
...
Current presence and verification: `research/verifications.json` → "Cupla", verified
...
- Current capture: `research/verifications.json` → "Cupla" (no live site exists; the
...
- Sources, asset credits and limitations: `research/verifications.json` → "Cupla";
  `public/images/place/ATTRIBUTION.md:13`.
