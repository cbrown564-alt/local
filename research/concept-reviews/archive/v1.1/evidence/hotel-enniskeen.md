...
`research/verifications.json` → Hotel Enniskeen, re-read for the F1 build on
23 July 2026.
...
- Current capture: `public/images/hotel-enniskeen-before.jpg`
- Desktop after, 1265×710: `public/images/hotel-enniskeen-after.jpg`
- Phone first screen, 390×844:
  `research/concept-reviews/evidence/hotel-enniskeen/phone-390x844.png`
- Current desktop first screen, 1265×710:
  `research/concept-reviews/evidence/hotel-enniskeen/desktop-1265x710.png`
- Primary-loop walkthrough or recording:
  `public/videos/hotel-enniskeen-reel.webm` and
  `research/enniskeen-flagship-plan.md`
...
- Sources, asset credits and limitations:
  `src/data/transformation-details.ts` → `hotel-enniskeen`
