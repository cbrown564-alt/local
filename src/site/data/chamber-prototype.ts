...
export type Member = {
  ...
  /** Date this business was last verified in research/pipeline/verifications.json. */
  verified: string;
};

/** Every listing is a real Newcastle business with a dated record in
 *  `research/pipeline/verifications.json`. The 25 July 2026 re-review failed the claims
...
export const events: EventItem[] = [
  ...
  },
  {
    ...
    dateSort: "2026-12-05",
    blurb:
      "Town-centre evening opening with member shops staying late — dates to be confirmed with traders and announced here.",
...
export const aboutParagraphs = [
  ...
  "This is not the Chamber's official website. Contact the committee to confirm anything before you act on it.",
];
