...
export const transformationDetails = {
    ...
    "notes": [
      {
        ...
        "body": "The practice's domain redirects, over insecure HTTP, to a DJ Maguire Dentists location page branded Newcastle Family Dental Care. A patient who types the address — or mails the one printed on the practice's own stationery — is taken away from the practice's own domain.",
        "change": "The practice's own front door — its own sentence, its three named dentists, its 2017 Dental Practice of the Year award and its hours — at an address it controls."
      },
      {
        "title": "Serve a health site over HTTPS",
        "body": "At the time of capture, the redirect used plain HTTP, so the practice's public route did not provide the secure connection patients expect from a health service.",
        "change": "Everything on a secure connection, stated plainly, with the padlock the practice's own domain currently lacks — and a request that drafts an email in the patient's own app rather than posting their details anywhere."
      },
      {
        "title": "Keep the online service on the practice's own address",
        "body": "The current DJ Maguire location page now offers an online service and a Book Online Now link, but the practice's own address still redirects there over plain HTTP. Patients can make an appointment, but not from an address the practice controls.",
        "change": "Keep the online service, but place it on a secure page at the practice's own address alongside the three dentists, the practice's own history and a plain two-step answer to what happens when you ring."
      }
    ],
    "sourceHtml": "<section class=\"source-section\">\n    <div class=\"shell source-grid\">\n      <div>\n        <p class=\"eyebrow\">Sources &amp; limits</p>\n        <h2>Clear about what is real.</h2>\n      </div>\n      <div>\n        <p>On 24 July 2026 the practice&#39;s domain redirected, over plain HTTP, to DJ Maguire Dentists&#39; Newcastle location page, and the .co.uk it publishes in its own email address had no working secure version — that captured redirect target is the before. The practice&#39;s three named dentists, their degrees, its Iveagh Court, 2 Railway Street address, its Monday-to-Friday hours, its phone number, its published email address and its private-appointments line all come from that page, where it is branded under its own name; it was re-read on 4 August 2026. Active trading under that name was confirmed by local first-hand knowledge on 24 July 2026.</p><p><strong>The concept draws on two layers and never blends them.</strong> The practice also had a website of its own, captured by the Internet Archive in 2018 and live to at least May 2019. Everything taken from it is quoted verbatim and carries its capture year on the page: &ldquo;We love to make you smile!&rdquo;, &ldquo;We provide high quality, ethical dentistry in a caring environment&rdquo;, the two surgeries &ldquo;equipped to the highest standards&rdquo;, and the practice being named Randox Healthcare Dental Practice of the Year for 2017 alongside its BDA Good Practice Scheme award. A nine-year-old award is shown as a nine-year-old award. Three archived-era facts are deliberately left off the page: NHS availability, which the 2018 site welcomed and the current page does not mention, so the concept neither promises nor denies it; the recorded out-of-hours message, which nobody has rung and re-heard; and the two published GDC numbers, because the third dentist&#39;s is not in the record and the row would be uneven.</p><p>The commercial relationship to DJ Maguire Dental Group is unestablished and may be ownership rather than hosting — this is noted, not assumed, and the concept says nothing about it in either direction. Nothing here is a clinical claim, and no treatment appears beyond the items the practice publishes. The appointment request sends nothing: it assembles the name, number and reason into a draft email to the practice&#39;s own published address, opened in the patient&#39;s own mail app, and the draft is withdrawn if a detail changes. The padlocked address bar is part of the proposal, not a live certificate, and the page banner says so. The proposed page is an independent concept, not a commissioned redesign.</p>\n        <ul>\n          <li><a href=\"http://www.djmaguiredentists.co.uk/location-newcastle.html\" rel=\"external\">The page the practice&#39;s domain currently redirects to</a></li>\n          <li><a href=\"https://web.archive.org/web/*/newcastlefamilydentalcare.co.uk\" rel=\"external\">The practice&#39;s own website in the Internet Archive, the source of every dated 2018 quotation</a></li>\n        </ul>\n        <p>No claim is made about the ownership arrangement, NHS availability, or the business&#39;s plans for the redirect.</p>\n        <a class=\"button\" href=\"/request/\">Request a free before-and-after for your business <span aria-hidden=\"true\">&rarr;</span></a>\n      </div>\n    </div>\n  </section>"
  },
  "hugh-mccanns": {
  ...
  "cupla": {
    ...
    "motion": {
      ...
      "afterAlt": "Ten-second visit to the Cúpla concept — the bilingual Fáilte isteach opening, the twin-ring mark and the paired Irish-and-English labels"
    },
    "secondSurfacesHtml": [
    ...
    "notes": [
      ...
      },
      {
        ...
        "change": "Build the identity around the pair: twin rings in the mark, with Irish first and English beside it so the café's bilingual voice is present from the start."
      },
      {
  ...
  "kent-amusements": {
    ...
    "motion": {
      ...
      "afterAlt": "Ten-second visit to the Kent Amusements concept — the Fifty summers on the Central Promenade opening, the promenade marquee and the attractions list"
    },
    "secondSurfacesHtml": [
      "<section class=\"second-surface\">\n    <div class=\"shell\">\n      <p class=\"second-surface-label\">Attractions</p>\n      <div class=\"second-surface-intro\">\n        <div>\n          <h2>Attractions, seasonal hours and family offers.</h2>\n          <p>A day's plan for families arriving at the Central Promenade — the three things to know before you go in: what is inside, when it opens and any offers running that season.</p>\n        </div>\n        <a class=\"text-link\" href=\"/concepts/kent-amusements/attractions/\">View the attractions screen <span aria-hidden=\"true\">→</span></a>\n      </div>\n      <div class=\"second-surface-frame\">\n        <img\n          src=\"/media/concepts/kent-amusements/kent-amusements-attractions-after.jpg\"\n          alt=\"Kent Amusements attractions concept showing three attraction cards — dodgems, VR games and arcade — on the left, with a seasonal hours board and family offers panel on the right\"\n          width=\"1265\"\n          height=\"710\"\n        />\n      </div>\n      <p class=\"second-surface-caption\">A companion to the opening page: attractions named, seasonal hours placed and a proposed place for family offers when the arcade posts them.</p>\n    </div>\n  </section>"
    ],
    "notesHeading": "Three changes to put the promenade out front.",
    "notes": [
      {
        "title": "Take the promenade out from behind the login",
        "body": "No working website was found in the review. Searching for the arcade lands on a Facebook page that greets a first-time visitor with Meta's cookie dialog and a login form — the Newcastle Central Promenade location sits greyed out behind them.",
        "change": "A clear page with nothing in front of it, opening on the one place fact that matters: fifty summers of family fun on the Central Promenade."
      },
      {
        "title": "Name what is inside before someone has to ask",
        "body": "Dodgems, the arcade floor and the new VR games are mentioned in social posts and third-party listings, so a family planning a day out has to search to learn what is available.",
      ...
      {
        "title": "Keep today's hours easy to find — and leave room for offers when they run",
        ...
        "change": "A clear place for today's hours, with a labelled proposed slot for seasonal family offers whenever the arcade posts them — both pointing at the Facebook page it already updates."
      }
    ],
  ...
  "mourne-cycles": {
    ...
    "notes": [
      ...
      },
      {
        ...
        "body": "The header phone number is the first screen's only action. The Workshop page explains repairs and tells visitors to contact the shop, but it provides no online booking path.",
      ...
      },
      {
        ...
        "body": "The five-category range on the showroom pages — electric, road, mountain, hybrid, kids — and the shop's Cyclescheme listing are real, but nothing on the opening screen showed where each kind of bike goes or how to save through work.",
        "change": "A category list across the foot of the page — each category mapped to local riding country, not product SKUs — with Cycle to Work as the clear route into salary-saving support."
      }
    ],
    "sourceHtml": "<section class=\"source-section\">\n    <div class=\"shell source-grid\">\n      <div>\n        <p class=\"eyebrow\">Sources &amp; limits</p>\n        <h2>Clear about what is real.</h2>\n      </div>\n      <div>\n        <p>The existing-site still was captured from the public Mourne Cycles website on 21 July 2026, and a ten-second demo clip on 23 July 2026. The shop's name and logo identity, the Ride with us tagline, the established-2002 wording, the LBS quote, the address, phone number and email, the brand list, the bike categories, the trails section heading and the Cyclescheme listing all come from that site. The concept uses generated illustrative visuals only; the workshop stand queue, trails map and service panels are drawn concept work. The bike visuals show riding contexts, not showroom stock or the shop's premises. Trek dealer photography reused in an earlier version was withdrawn on 25 July 2026 because no licence for it was on record. Hire prices, service tiers, workshop tickets and Cycle to Work figures are illustrative throughout. The proposed page is an independent concept, not a commissioned redesign.</p>\n        <ul>\n          <li><a href=\"https://www.mourne-cycles.co.uk/\" rel=\"external\">Mourne Cycles public website</a></li>\n          <li><a href=\"https://find-and-update.company-information.service.gov.uk/company/NI064124\" rel=\"external\">Companies House record used to verify current trading</a></li>\n        </ul>\n        <p>No claim is made about sales performance, customer approval or the business's plans for its current site.</p>\n        <a class=\"button\" href=\"/request/\">Request a free before-and-after for your business <span aria-hidden=\"true\">→</span></a>\n      </div>\n    </div>\n  </section>"
  },
  "newcastle-chamber": {
    ...
    "notes": [
      {
        ...
        "body": "No working website was found in the review. Search results mix the Chamber with organisations elsewhere, while its public Facebook presence is hard for a first-time visitor to use as a reliable front door.",
      ...
      },
      {
        ...
        "change": "A Main Street finder at the top of the page: search into a category directory, a trade list and a clear route for businesses that want to join."
      },
      {
  ...
  "tool-centre": {
    ...
    "motion": {
      ...
      "afterAlt": "Ten-second visit to The Tool Centre concept — the Hardware on the shelf, Hire on the yard opening, the hire-desk rates board and the stock-category list"
    },
    "secondSurfacesHtml": [
      "<section class=\"second-surface\">\n    <div class=\"shell\">\n      <div class=\"second-surface-intro\">\n        <div>\n          <p class=\"second-surface-label\">Hire list</p>\n          <h2>A standalone hire-rate sheet.</h2>\n          <p>The hire desk on the opening page asks callers to ring for day rates. A separate page gives that list a permanent address — four categories of plant and tools, indicative prices, and one call button using the same counter number.</p>\n        </div>\n        <a class=\"text-link\" href=\"/concepts/tool-centre/hire-list/\">View the hire list concept <span aria-hidden=\"true\">→</span></a>\n      </div>\n      <div class=\"second-surface-frame\">\n        <img src=\"/media/concepts/tool-centre/tool-centre-hire-list-after.jpg\" alt=\"The Tool Centre hire list concept: a two-column price sheet in yard black and badge yellow, showing four hire categories — power tools, garden machinery, plant and site, access equipment — with indicative day rates and a call panel in the sidebar\" width=\"1265\" height=\"710\" loading=\"lazy\" />\n      </div>\n      <p class=\"second-surface-caption\">Hire price list · indicative rates in four categories · same phone number as the opening page</p>\n    </div>\n  </section>"
    ],
    ...
    "notes": [
      ...
      },
      {
        ...
        "change": "One brand lock-up that carries both: The Tool Centre with Hardware · Plant & tool hire underneath, and a short line that names the Facebook trading style so visitors can see how the two names relate."
      },
      {
