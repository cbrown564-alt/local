...
export const transformationDetails = {
  ...
  "tool-centre": {
    ...
    "motion": {
      ...
      "afterAlt": "Ten-second visit to The Tool Centre concept — the Hardware on the shelf, Hire on the yard opening, the hire-desk board that asks callers to ring, and the shelf-counter-yard band resolving the shop's two trading names into one address"
    },
    "secondSurfacesHtml": [
    ...
    "notes": [
      ...
      },
      {
        ...
        "change": "Both screens end on a shelf–counter–yard band that states it outright: The Tool Centre on Main Street and Tool Centre Plant Hire on Facebook are one shop, with one counter, one number and one address between them. The brand lock-up carries both names, and the county is repeated wherever a stranger meets the shop."
      },
      {
