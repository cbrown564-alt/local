...
export const transformationDetails = {
  ...
  "mourne-cycles": {
    ...
    "motion": {
      ...
      "afterAlt": "Ten-second visit to the Mourne Cycles concept — the kinetic Mourne Cycles opening riding in over a generated trail plate, the terrain-mapped range rail, the workshop desk and the trails ridgeline"
    },
    "secondSurfacesHtml": [
    ...
    "notesHeading": "Five changes to put the shop first.",
    "notes": [
      {
        ...
        "change": "The shop's own mountain mark and its own words — established 2002, one of Northern Ireland's premier local bike shops — take the opening screen; Trek and the component brands become one confident line in the story. A complete six-page site now stands behind it: bikes, workshop, hire, Cycle to Work and trails, every nav item a real page."
      },
      {
        ...
        "change": "A booking widget on the workshop page: pick a service tier and a preferred day in an accessible calendar, add a note about the bike, and the details are carried into a composed email to the workshop. The shop confirms every slot — nothing pretends to live availability — and without JavaScript the phone and email links stand in."
      },
      {
      ...
      },
      {
        ...
        "body": "The shop sits on the road out of Newcastle toward Castlewellan — literally the trailhead — and its own site maintains an Our local Trails section nobody designed for.",
        "change": "A trails page in two moves: the real Mourne skyline above Newcastle, sampled from open SRTM-derived elevation data and drawn in as you arrive, with a marker walking the ridge and naming the height under it; and the illustrated map of the riding country — Castlewellan, Tollymore, Donard, the coast road — disclosed as indicative, not navigational."
      },
      {
        ...
        "change": "A bikes page mapping each category to local riding country, not product SKUs, and a Cycle to Work page walking a named Cyclescheme worked example — every figure labelled illustrative."
      }
    ],
    "sourceHtml": "<section class=\"source-section\">\n    <div class=\"shell source-grid\">\n      <div>\n        <p class=\"eyebrow\">Sources &amp; limits</p>\n        <h2>Clear about what is real.</h2>\n      </div>\n      <div>\n        <p>The existing-site still was captured from the public Mourne Cycles website on 21 July 2026, and a ten-second demo clip on 23 July 2026. The shop's name and logo identity, the Ride with us tagline, the established-2002 wording, the LBS quote, the address, phone number and email, the brand list, the bike categories, the trails section heading and the Cyclescheme listing all come from that site. The concept uses generated illustrative visuals only; the workshop stand queue, trails map and service panels are drawn concept work. The bike visuals show riding contexts, not showroom stock or the shop's premises. Trek dealer photography reused in an earlier version was withdrawn on 25 July 2026 because no licence for it was on record. Hire prices, service tiers, workshop tickets and Cycle to Work figures are illustrative throughout. The trails skyline is drawn from open SRTM-derived elevation data, sampled at build time and labelled indicative; the illustrated trails map is indicative, not navigational. The workshop booking widget composes an email carrying the chosen service and day — the shop confirms every slot, and no online booking or live availability is implied. Ownership remains unverified in the studio dataset, so no person is named anywhere on the concept. The proposed page is an independent concept, not a commissioned redesign.</p>\n        <ul>\n          <li><a href=\"https://www.mourne-cycles.co.uk/\" rel=\"external\">Mourne Cycles public website</a></li>\n          <li><a href=\"https://find-and-update.company-information.service.gov.uk/company/NI064124\" rel=\"external\">Companies House record used to verify current trading</a></li>\n        </ul>\n        <p>No claim is made about sales performance, customer approval or the business's plans for its current site.</p>\n        <a class=\"button\" href=\"/request/\">Request a free before-and-after for your business <span aria-hidden=\"true\">→</span></a>\n      </div>\n    </div>\n  </section>"
  },
  "newcastle-chamber": {
