...
export const transformationDetails = {
  ...
  "kent-amusements": {
    ...
    "motion": {
      ...
      "afterAlt": "Ten-second visit to the Kent Amusements concept — the machines-change opening beside a quoted 1960s memory of the arcade, the dated fifty-summers band and the staged afternoon"
    },
    "secondSurfacesHtml": [
    ...
    "notesHeading": "Four changes to put this arcade, and no other, out front.",
    "notes": [
          {
                ...
                "change": "That memory quoted verbatim as the opening screen's emotional centre, carrying who is speaking, the era it is speaking about, the archive it is preserved in and a link to the rest of it. The Avoca Hotel's present-tense description sits beside it, attributed to the Avoca, whose words \"premier\" and \"one of NI's only homes to indoor Dodgem Cars\" stay theirs."
          },
          {
                ...
                "change": "A four-entry band from the late 1960s to 2026, each entry carrying its source and its date: the BBC memories, the verified promenade tenure, the November 2025 Companies House filing and the March 2026 review that named the VR. Jukebox to VR in one glance; no undated milestone anywhere in it."
          },
          {
                ...
                "change": "The visit in the order it happens: the promenade, the change, the floor, the dodgems, the VR, back out to the sea. The change is the hinge, where the sixties memory and this afternoon are the same afternoon. Nothing is added to the record to fill it out — no tokens, tickets, prices or packages."
          },
          {
