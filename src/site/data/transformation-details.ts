    ...
    "notes": [
      {
        ...
        "body": "The current site lists a substantial body of work — ecclesiastical, healthcare, education and more — as plain text links beneath a small carousel. A prospective client has to open those links one by one to understand the breadth of the work.",
  ...
  "hugh-mccanns": {
    ...
    "notes": [
      ...
      },
      {
        ...
        "change": "Keep the site's own voice and images, and add the missing date capture beside them."
      },
      {
