...
export const dishes = [
  ...
  },
  {
    ...
    copy: "“Carrots like you've never tasted them before.” The plate that carries the week's best roots, in Paul's own words.",
...
const dayPartSources: readonly DayPartSource[] = [
  ...
  },
  {
    ...
    caption: "The buttermilk chicken burger · illustrated after Scopers' own post",
    steam: false,
    tone: "light",
    position: "72% 50%",
  },
