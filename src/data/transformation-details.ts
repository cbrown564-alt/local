  ...
  "bucks-head": {
    ...
    "notes": [
      ...
      },
      {
        ...
        "change": "A booking card on the first screen — date, time, party, area — passing straight into the same ResDiary engine the pub already runs, with the party-size limit reduced to one calm line beneath the button."
      },
      {
  ...
  "hotel-enniskeen": {
    ...
    "notes": [
      ...
      },
      {
        ...
        "body": "Book Now is one menu item among seven, and checking availability means leaving for the booking engine with no dates in hand.",
        "change": "A persistent availability bar — arrive, nights, guests — that passes straight into the hotel's existing Bookin1 engine."
      },
      {
    ...
    "sourceHtml": "<section class=\"source-section\">\n    <div class=\"shell source-grid\">\n      <div>\n        <p class=\"eyebrow\">Sources &amp; limits</p>\n        <h2>Clear about what is real.</h2>\n      </div>\n      <div>\n        <p>The existing-site still and a ten-second demo clip were captured from the public Enniskeen website on 23 July 2026; the arrival cookie prompt was closed first so the comparison shows the page itself. The hotel's name, the mountainside hideaway and Shimna Valley wording, the estate details, the phone number, the photographs and the Bookin1 booking engine all come from that site. The layout, copy hierarchy and proposed experience are independent concept work.</p>\n        <ul>\n          <li><a href=\"https://www.enniskeenhotel.co.uk/\" rel=\"external\">Enniskeen public website</a></li>\n          <li><a href=\"https://www.tripadvisor.co.uk/Hotel_Review-g186478-d1462012\" rel=\"external\">TripAdvisor listing used to verify current trading</a></li>\n        </ul>\n        <p>No claim is made about sales performance, customer approval or the internal decisions behind the current site.</p>\n        <a class=\"button\" href=\"/request/\">Request a free before-and-after for your business <span aria-hidden=\"true\">→</span></a>\n      </div>\n    </div>\n  </section>"
  },
  "kent-amusements": {
  ...
  "mourne-cycles": {
    ...
    "notes": [
      ...
      },
      {
        ...
        "change": "A range rail across the foot of the screen, the five categories numbered like a parts catalogue, with Cycle to Work as the red cell that opens the salary-saving funnel."
      }
    ],
