...
2. **Keep concept code, deployed assets and research separate:** `src/concepts/<slug>/`, `public/media/concepts/<slug>/`, `research/concepts/<slug>/`. Retired binary assets belong under `media/held/concepts/<slug>/`, outside the deployment.
