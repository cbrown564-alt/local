...
`node tools/check-concept-reviews.mjs --fingerprint donard-veterinary` returns the
...
Current presence and verification: `research/pipeline/verifications.json`, census join key
...
- Sources, asset credits and limitations: `public/media/place/ATTRIBUTION.md` line 12;
  `research/pipeline/verifications.json`. Nothing on-page.
- Asset source and public-use rights status:
  `public/media/concepts/donard-veterinary/donard-veterinary-exterior-2023.jpg`, measured **1024×644** —
...
(`tools/check-concept-reviews.mjs` is the canonical calculator and rounds half-up;
