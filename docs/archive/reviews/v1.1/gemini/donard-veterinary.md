...
Current presence and verification: `research/pipeline/verifications.json`, record named
...
- **Supplied bundle is unreliable.** The pre-captured evidence in
  `research/concepts/phase-q-rereview/evidence/` was made with
...
- Sources, asset credits and limitations: `public/media/place/ATTRIBUTION.md`
  line 12; `research/pipeline/verifications.json`. Nothing on-page.
- Asset source and public-use rights status:
  `public/media/concepts/donard-veterinary/donard-veterinary-exterior-2023.jpg` (1024×644) —
