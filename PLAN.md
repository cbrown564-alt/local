...
Snapshot: 22 July 2026 · 6 shortlist concepts published · 3 shortlist landings remaining · South Down Signs on hold
...
| Business | Town | Type | Landing brief |
|---|---|---|---|
| **The Tool Centre** | Newcastle | First website | Utilitarian trade site: hire prices, stock categories, hours |
| **Kent Amusements** | Newcastle | First website | Seasonal attraction site: attractions, hours, family offers |
| **Newcastle Chamber of Commerce** | Newcastle | First website / community | Civic hub: member directory, events, join page |
...
- **South Down Signs** — no concept until trading is confirmed in person. Rejoin this milestone only after that caveat clears.
...
```
M1 Tool Centre landing
M1 Kent Amusements landing
M1 Chamber landing
...
South Down Signs inserts into M1 only after trading confirmation; otherwise it stays out of the first outreach wave.
